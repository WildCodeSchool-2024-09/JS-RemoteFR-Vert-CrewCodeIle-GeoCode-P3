export default function ModalRegistrationValidate() {
  return (
    <section className="h-60 flex justify-center items-center text-center font-paragraph bg-lightColor w-5/6 mx-auto my-12 rounded-2xl  z-[10000] fixed top-32 left-8  -translate-y-1/2 -translate-x1/2  lg:w-36 ">
      <article>
